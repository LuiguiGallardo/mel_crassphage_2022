---
title: "Alpha diversity crAssphage, No definido"
...
# Data input
table <- read.table("allsamples_adiv_no-definido.tsv",
                    header=TRUE,
                    sep="\t",
                    row.names = 1)
...
ggsave("boxplot_no-definido_observed_comp.svg")
...
ggsave("boxplot_no-definido_chao1_comp.svg")
  print(boxplot_chao1)
dev.off()
...
ggsave("boxplot_no-definido_shannon_comp.svg")
...
ggsave("boxplot_no-definido_simpson_comp.svg")
...
ggsave("boxplot_no-definido_goods_coverage_comp.svg")
